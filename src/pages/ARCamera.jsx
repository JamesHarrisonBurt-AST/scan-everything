        ...
        <div className="absolute inset-0 z-40 flex flex-col items-center justify-center px-8 text-center">
          {cameraError === 'permission' ? (
            <>
              ...
              <button onClick={startCamera} className="px-5 h-10 rounded-xl text-sm font-bold" style={{ background: 'linear-gradient(135deg, hsl(35 95% 55%), hsl(25 90% 45%))', color: 'white' }}>Try Again</button>
